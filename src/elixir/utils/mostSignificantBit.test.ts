...
import { ONE, SOLIDITY_TYPE_MAXIMA, SolidityType } from '../../constants'
...
describe('mostSignificantBit', () => {
  ...
  it('succeeds for MaxUint256', () => {
    expect(mostSignificantBit(SOLIDITY_TYPE_MAXIMA[SolidityType.uint256])).toEqual(255)
  })

  it('throws for MaxUint256 + 1', () => {
    expect(() => mostSignificantBit(JSBI.add(SOLIDITY_TYPE_MAXIMA[SolidityType.uint256], ONE))).toThrow('MAX')
  })
})
