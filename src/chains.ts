...
export const ETHEREUM_MAINNET: Chain = {
  ...
  symbol: 'ETH',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/eth.png',
...
export const ARBITRUM_MAINNET: Chain = {
  ...
  symbol: 'ARB',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/arb.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: true,
...
export const AURORA_MAINNET: Chain = {
  ...
  symbol: 'AURORA',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/aurora.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
...
export const AVALANCHE_MAINNET: Chain = {
  ...
  png_symbol: 'PNG',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/avax.png',
...
export const BOBA_MAINNET: Chain = {
  ...
  symbol: 'BOBA',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/boba.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const BITTORRENT_MAINNET: Chain = {
  ...
  symbol: 'BTT',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/btt.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const BSC_MAINNET: Chain = {
  ...
  symbol: 'BSC',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/bsc.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: true,
...
export const CELO_MAINNET: Chain = {
  ...
  symbol: 'CELO',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/celo.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const CRONOS_MAINNET: Chain = {
  ...
  symbol: 'CRO',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/cro.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const COSTON_TESTNET: Chain = {
  ...
  mainnet: false,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/flare.png',
  pangolin_is_live: true,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const EVMOS_TESTNET: Chain = {
  ...
  symbol: 'tEVMOS',
  mainnet: false,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/evmos.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const FANTOM_MAINNET: Chain = {
  ...
  symbol: 'FTM',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/ftm.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: true,
...
export const FUSE_MAINNET: Chain = {
  ...
  symbol: 'FUSE',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/fuse.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const HARMONY_MAINNET: Chain = {
  ...
  symbol: 'ONE',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/one.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const HECO_MAINNET: Chain = {
  ...
  symbol: 'HECO',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/heco.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const KLAYTN_MAINNET: Chain = {
  ...
  symbol: 'KLAY',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/klay.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const METIS_MAINNET: Chain = {
  ...
  symbol: 'METIS',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/metis.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const MOONRIVER_MAINNET: Chain = {
  ...
  symbol: 'MOVR',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/movr.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const MOONBEAM_MAINNET: Chain = {
  ...
  symbol: 'MOBM',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/mobm.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const OEC_MAINNET: Chain = {
  ...
  symbol: 'OKT',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/okt.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const OP_MAINNET: Chain = {
  ...
  symbol: 'OP',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/op.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const POLYGON_MAINNET: Chain = {
  ...
  symbol: 'MATIC',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/matic.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: true,
...
export const SONGBIRD_MAINNET: Chain = {
  ...
  symbol: 'SGB',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/sgb.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const WAGMI_FUJI_SUBNET: Chain = {
  ...
  symbol: 'WGMI',
  mainnet: false,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/wgmi.png',
  pangolin_is_live: true,
  tracked_by_debank: false,
  supported_by_gelato: false,
  rpc_uri: 'https://subnets.avax.network/wagmi/wagmi-chain-testnet/rpc',
  contracts: {
    png: '0xA1b28Bf8cc9e2D509b9836Ddf8f0CfDBcc4Bf1ae',
    factory: '0x7B39e9a40Ef6432341c8Ce30d717992ee2393fc8',
    router: '0x4836c95a94D0e12121b68783723ae013428e2679',
    wrapped_native_token: '0x3Ee7094DADda15810F191DD6AcF7E4FFa37571e4',
    local_multisig: '0x0000000000000000000000000000000000000000',
    community_treasury: '0xdbDEcae518FD0AeF22E58Ffd068747C81decf93c',
    treasury_vester: '0x322A27dBCE55FbEff7Dc6c5b545b827Fbce57aDB',
    mini_chef: '0xCb36d1dAa732c02d62Edd72902842c0B7D7b8Cb1',
    airdrop: '0xAEe64CD0fFb0F1F0b5c72c13E4DD88B216926bED',
    timelock: '0xCABcbF671d51Caafd0F3fd19c92Be535B9a89204',
    governor: '0x0000000000000000000000000000000000000000',
    migrator: '0x0000000000000000000000000000000000000000',
    staking: [
      {
        address: '0x1E126D39c47d19dd9B58ad9199495f3F943e0805',
        active: true,
        reward_token: '0xA1b28Bf8cc9e2D509b9836Ddf8f0CfDBcc4Bf1ae',
      }
    ]
  },
  nativeCurrency:{
...
export const XDAI_MAINNET: Chain = {
  ...
  symbol: 'XDAI',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/xdai.png',
  pangolin_is_live: false,
  tracked_by_debank: true,
  supported_by_gelato: false,
...
export const EWC_MAINNET: Chain = {
  ...
  symbol: 'EWT',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/ewc.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const IOTEX_MAINNET: Chain = {
  ...
  symbol: 'IOTX',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/iotx.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const ASTAR_MAINNET: Chain = {
  ...
  symbol: 'ASTR',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/astr.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const TELOS_MAINNET: Chain = {
  ...
  symbol: 'TLOS',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/telos.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
...
export const OASIS_MAINNET: Chain = {
  ...
  symbol: 'ROSE',
  mainnet: true,
  logo: 'https://raw.githubusercontent.com/antiyro/sdk/master/src/images/chains/oasis.png',
  pangolin_is_live: false,
  tracked_by_debank: false,
  supported_by_gelato: false,
