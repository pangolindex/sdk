...
export const NEAR_MAINNET: Chain = {
  ...
  contracts: {
    png: 'example.near',
    factory: 'example.near',
    router: 'example.near',
    wrapped_native_token: 'example.near',
    local_multisig: 'example.near',
    community_treasury: 'example.near',
    treasury_vester: 'example.near',
    mini_chef: 'example.near',
    airdrop: 'example.near',
    timelock: 'example.near',
    governor: 'example.near',
    migrator: 'example.near',
  },
  nativeCurrency: {
    name: 'Near',
    symbol: "NEAR",
