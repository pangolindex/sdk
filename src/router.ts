...
/**
 * The parameters to use in the call to the V2 Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the V2 Router.
   */
  methodName: string
  /**
...
/**
 * Represents the  V2 Router, and has static methods for helping execute trades.
 */
