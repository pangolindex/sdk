...
export class Currency {
  ...
  public static readonly CURRENCY = {
    ...
    [ChainId.NEAR_MAINNET]: new Currency(18, CHAINS[ChainId.NEAR_MAINNET].symbol, CHAINS[ChainId.NEAR_MAINNET].name),
    [ChainId.NEAR_TESTNET]: new Currency(18, CHAINS[ChainId.NEAR_TESTNET].symbol, CHAINS[ChainId.NEAR_TESTNET].name),
  }
